...
# 두물머리(북한강·남한강 합류부) 금지구역 — KCG 현장도 020501 디지타이징(좌표격자 없어 대략, ~100-200m)
DUMUL_020501 = [
    [127.31188,37.52993], [127.31344,37.53208], [127.31486,37.53400], [127.31684,37.53683],
    [127.31854,37.53920], [127.31996,37.54112], [127.32151,37.54316], [127.31245,37.56170],
    [127.31358,37.56159], [127.32010,37.56159], [127.32605,37.56159], [127.33653,37.56159],
    [127.33709,37.56125], [127.34063,37.54508], [127.34347,37.54440], [127.34644,37.54372],
    [127.34927,37.54305], [127.34956,37.54237], [127.35069,37.53999], [127.35196,37.53762],
    [127.35409,37.53366], [127.35536,37.53106], [127.35664,37.52857], [127.35820,37.52552],
    [127.36004,37.52201], [127.36244,37.51738], [127.36584,37.51082], [127.36882,37.50494],
    [127.36655,37.50369], [127.34460,37.51376], [127.34205,37.51229], [127.33908,37.51048],
    [127.33582,37.50856], [127.33199,37.50641], [127.32718,37.50347], [127.32081,37.49974],
    [127.31117,37.49397], [127.31089,37.49386], [127.30877,37.50121], [127.30721,37.50709],
    [127.30593,37.51172], [127.30480,37.51591], [127.30452,37.51975], [127.30763,37.52405],
    [127.30990,37.52721], [127.31188,37.52993],
]
...
def main():
    ...
    # 두물머리(양평·양서)와 조안면(남양주) 구역이 같은 KCG 현장도(020501)에 하나의 외곽선으로 함께 그려짐 → 단일 폴리곤으로 표현.
    # (구 '북한강 조안면 구역' weir_zone 박스는 OSM 스냅으로 ~4km 북쪽 오배치 → 제거, 020501 범위에 포함)
    add("남한강·북한강 두물머리·조안면 구역(양평·남양주·광주)", [DUMUL_020501], ALL_,"연중","양평군·남양주시·광주시",
        "KCG 내수면 금지구역 현장도(020501, 두물머리+조안면) 기준 디지타이징 — 대략 표시(세부 경계는 관할 고시 참조)")
    ...
    print("승촌보…"); add(
        "영산강 승촌보 상·하류 1km 구역",
        weir_zone([35.06523178,126.76606233], "영산강", 1000, 1000, 250),
        UNKNOWN, "영구", "나주시",
        "해경 공식 현황표: 승촌보 기준 상·하류 각 1km(금지대상 기구 미기재) — 카누 적용 여부와 세부 수면 경계는 관할 고시 확인",
    ); S()
    ...
    print("하동 화개…")
    hadoong_080301 = [[
        [127.65660,35.16090], [127.65950,35.15990], [127.66290,35.15710],
        [127.66690,35.15440], [127.66875,35.15355], [127.66795,35.15155],
        [127.66595,35.15195], [127.66355,35.15320], [127.66100,35.15485],
        [127.65840,35.15720], [127.65660,35.16090]
    ]]
    add("섬진강 하동 구역(화개장터 일원)", hadoong_080301, ALL_,"연중","하동군",
        "KCG 내수면 금지구역 도면(080301) 기준 재작도 — 대략 표시(세부 경계는 관할 고시 참조)")
    S()
