...
<meta name="twitter:image" content="https://crowdbase.kr/og.png">
__GTAG__
...
function extLinks(lat,lng,label,hasRv){   // hasRv===false 면 로드뷰 링크 숨김(없는 곳)
  ...
  if(isAndroid){
    ...
    n='intent://place?lat='+lat+'&lng='+lng+'&name='+enc+'&appname=crowdbase.kr#Intent;scheme=nmap;package=com.nhn.android.nmap;S.browser_fallback_url='+encodeURIComponent('https://map.naver.com/p/search/'+lat+','+lng)+';end';
    ...
    n='nmap://place?lat='+lat+'&lng='+lng+'&name='+enc+'&appname=crowdbase.kr';
