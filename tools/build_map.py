...
let _riverMain=null,_riverStream=null,_riverLoading=null,_riverControlAdded=false,_riverFeatures=[],_riverPopup=null,_riverPopupSeq=0;
...
function clearRiverSearch(){_riverPopupSeq++;_riverSearchFocus.clearLayers();if(_riverPopup){map.closePopup(_riverPopup);_riverPopup=null;}}
...
function focusRiverSearch(x){
  clearRiverSearch();const seq=++_riverPopupSeq,bounds=L.latLngBounds([]);let anchor=null;
